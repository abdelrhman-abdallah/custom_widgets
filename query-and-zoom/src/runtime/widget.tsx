...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  const [query,setQuery] = useState<FeatureLayerQueryParams|null>(null);
  ...
  const isDsConfigured = ()=>{
    if(props.useDataSources && props.useDataSources.length ===1 && props.useDataSources[0].fields && props.useDataSources[0].fields.length === 1){
      return true;
    }
    else{
      return false;
